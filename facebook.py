...
class GraphAPI(object):
    ...
    def request(self, path, args=None, post_args=None):
        ...
        logging.debug('Sending request: https://graph.facebook.com/%s?%s  with post data: %s', path, urllib.urlencode(args), str(post_data))
    ...
    def request_url(self, url):
        ...
        logging.debug('Sending request to url: ' + url)
